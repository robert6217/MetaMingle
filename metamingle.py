...
def add_exif_watermark(image_path, output_path=None, border_width=100, logo_path=None, logo_size_percent=30,
                       font_size=120, text_color=(0, 0, 0)):
    """
    ...
    Args:
        ...
        border_width (int, optional): Left, right, and top border width, default is 100 pixels.
        logo_path (str, optional): Camera logo image file path.
		logo_size_percent (int, optional): logo size
        font_size (int, optional): Font size, default is 120.
    ...
    new_width = int(width + 2 * border_width)
    
    # The bottom white border is four times the height of the original.
    bottom_height = int(border_width*2*4)
    new_height = int(height + border_width + bottom_height)
    
    # Create a new image with a white background.
    new_img = Image.new('RGB', (new_width, new_height), (255, 255, 255))
    
    # Paste the original image at the center of the new image.
    new_img.paste(img, (int(border_width), int(border_width)))
    ...
    if logo_path and os.path.exists(logo_path):
        try:
            ...
            logo_max_height = int(bottom_height * (logo_size_percent / 100.0))
            ...
            logo_y = int(height + border_width + 130)  # Place the logo at the top of the bottom area.
            ...
            logo_height = logo_new_height + 130
