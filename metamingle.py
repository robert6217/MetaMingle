...
def add_exif_watermark(image_path, output_path=None, border_width=100, logo_path=None,
                       font_path=None, font_size=120, text_color=(0, 0, 0)):
    """
    ...
    bottom_height = border_width*2*4
    ...
    if logo_path and os.path.exists(logo_path):
        try:
            ...
            logo_max_height = int(bottom_height * 0.3)
            ...
            logo_y = height + border_width + 130  # Place the logo at the top of the bottom area.
